# -*- coding: utf-8 -*-
"""neural-operator-attention-16-64.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17gcMDvPG2TB24DJBPHW8y8O94-JKvCVX
"""
...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes=8, reduction=4, n_modes=16, hidden_channels=64):
...
class SpatialAttention(nn.Module):
    def __init__(self, kernel_size=7, n_modes=16, hidden_channels=64):
...
class CBAM_FNO_NeuralOp(nn.Module):
    def __init__(self, in_planes=8, hidden_channels=64,  n_modes=16, reduction=1, kernel_size=7):
...
class FNOShuffle(nn.Module): #in_planes=8, hidden_channels=16,  n_modes=2, reduction=1, kernel_size=7
    def __init__(self, channels, n_modes=16, hidden_channels=64, reduction=1):
...
class FNOShuffleNet(nn.Module): #in_planes=8, hidden_channels=16,  n_modes=2, reduction=1, kernel_size=7
    def __init__(self, in_channels=16, num_classes=6, n_modes=16, hidden_channels=64, reduction=1):
...
model = FNOShuffleNet(n_modes=16, hidden_channels = 64)
